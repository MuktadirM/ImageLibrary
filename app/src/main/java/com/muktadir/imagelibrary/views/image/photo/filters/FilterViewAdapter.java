package com.muktadir.imagelibrary.views.image.photo.filters;
...
import com.muktadir.imagelibrary.databinding.RowFilterViewBinding;
...
public class FilterViewAdapter extends RecyclerView.Adapter<FilterViewAdapter.ViewHolder> {
    private final OnItemSelectedFilter mFilterListener;
    private final List<Pair<String, PhotoFilter>> mPairList = new ArrayList<>();

    public FilterViewAdapter(OnItemSelectedFilter filterListener) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        RowFilterViewBinding binding = RowFilterViewBinding.inflate(inflater,parent,false);
        return new ViewHolder(binding,mFilterListener);
    }
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.binding.txtFilterName.setText(filterPair.second.name().replace("_", " "));
    }
    ...
    class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        private final RowFilterViewBinding binding;
        private final OnItemSelectedFilter mFilterListener;

        ViewHolder(RowFilterViewBinding binding,OnItemSelectedFilter filterListener) {
